...
{ 
  ...
  */
  ...
  static _Thread_local ddf_Arow rcost;
  static _Thread_local ddf_colrange d_last=0;
  static _Thread_local ddf_colset tieset,stieset;  /* store the column indices with tie */
 ...
 */
{
  ...
  static _Thread_local ddf_Arow Rtemp;
...
{ 
  ...
  */
  ...
  static _Thread_local ddf_colrange d_last=0;
  static _Thread_local ddf_Arow rcost;
  static _Thread_local ddf_colindex nbindex_ref; /* to be used to store the initial feasible basis for lexico rule */
...
*/
{
  ...
  ddf_rowrange i,r;
  ddf_colrange j,s;
  static _Thread_local ddf_rowindex bflag;
  static _Thread_local long mlast=0,nlast=0;
  static _Thread_local ddf_rowindex OrderVector;  /* the permutation vector to store a preordered row indeces */
  static _Thread_local ddf_colindex nbindex_ref; /* to be used to store the initial feasible basis for lexico rule */
...
*/
{
  ...
  static _Thread_local ddf_rowindex bflag;
  static _Thread_local long mlast=0;
  static _Thread_local ddf_rowindex OrderVector;  /* the permutation vector to store a preordered row indices */
  unsigned int rseed=1;
  myfloat val;
  ddf_colindex nbtemp;
